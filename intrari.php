...
$query = "SELECT * FROM intrari ORDER BY ID ASC";
...
<head>
  ...
  <a href="Iesiri.php">Iesiri</a>
	<a href="adaugaintrari.php?adauga">Adaugă intrare</a>
    <div class="topnav-right">
    </div>
  </div>
</head>
<body>
	<h1 align="center">Intrari</h1>
	...
	if($result -> num_rows > 0){
		while($row = $result->fetch_assoc()){
			...
			<!-- Edit -->
			<td><a href="editintrari.php?ID=<?php echo $row['ID']; ?>" alt="edit" > Modifică </a></td>
			</tr>
		<?php
		}
	}
